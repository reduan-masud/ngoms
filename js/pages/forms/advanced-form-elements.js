$(function () {
    ...
    //Mobile Phone Number
    $demoMaskedInput.find('.mobile-phone-number').inputmask('99999-999-999', { placeholder: '_____-___-___' });

    //Phone Number
    $demoMaskedInput.find('.phone-number').inputmask('+99 (999) 999-99-99', { placeholder: '+__ (___) ___-__-__' });

    //Dollar Money
    $demoMaskedInput.find('.money-dollar').inputmask('99-99-99-999 $', { placeholder: '__-__-__-___' });
    //Euro Money
    ...
    //Nid Card
    $demoMaskedInput.find('.ip').inputmask('9999-9999-9999-99999', { placeholder: '____-____-____-_____' });
